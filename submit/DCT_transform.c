                                                               ...
                                                               void *cl)
{
        ...
        signed a_signed = (signed)round(a_float * 63);

        /* Convert 'b', 'c', and 'd' to 5-bit signed integers */
        signed b_signed = (signed)round((b_float / 0.3) * 31);
        signed c_signed = (signed)round((c_float / 0.3) * 31);
        signed d_signed = (signed)round((d_float / 0.3) * 31);
                                                              ...
                                                              void *cl)
{
        ...
        float a_float = (float)curr_pixel->a / 63.0;
        float b_float = ((float)curr_pixel->b / 31.0) * 0.3;
        float c_float = ((float)curr_pixel->c / 31.0) * 0.3;
        float d_float = ((float)curr_pixel->d / 31.0) * 0.3;
