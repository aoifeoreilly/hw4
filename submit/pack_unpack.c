                                                              ...
                                                              void *cl)
{
        ...
        *word = Bitpack_newu(*word, 6, 26, curr_pixel->a);
        *word = Bitpack_news(*word, 6, 20, curr_pixel->b);
        *word = Bitpack_news(*word, 6, 14, curr_pixel->c);
        *word = Bitpack_news(*word, 6, 8, curr_pixel->d);
                                                                  ...
                                                                  void *cl)
{
        ...
        curr_pixel->a = Bitpack_getu(*word, 6, 26);
        curr_pixel->b = Bitpack_gets(*word, 6, 20);
        curr_pixel->c = Bitpack_gets(*word, 6, 14);
        curr_pixel->d = Bitpack_gets(*word, 6, 8);
