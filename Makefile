...
40image: 40image.o compress_decompress.o uarray2b.o uarray2.o trimPPM.o convert_comp_rgb.o block_unblock.o DCT_transform.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS) 

unit_tests: unit_tests.o uarray2b.o uarray2.o compress_decompress.o trimPPM.o convert_comp_rgb.o block_unblock.o DCT_transform.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
